...
import EditMode from "../../components/npc/EditMode";
...
import EditAdvanced from "../../components/npc/EditAdvanced";
...
export default function NpcEdit() {
  ...
  return (<Layout>
      <Grid container spacing={2}>
        ...
        {npcTemp.mode !== 'advanced' && <Grid item xs={5}>
      ...
      <Grid item xs={12}>
        <EditMode npc={npcTemp} setNpc={setNpcTemp}/>
      </Grid>
      
      {npcTemp.mode === 'advanced' && <EditAdvanced npc={npcTemp} setNpc={setNpcTemp}/>}
      
      {npcTemp.mode !== 'advanced' && <>
